...
better than $\tilde y$, i.e. has a lower value of loss.
 in the Loewner sense, i.e $V-W$ is positive semidefinite. 

::: {#lem-major}
Suppose $V\gtrsim W$.Define $z:=V^{-1}W(x-\tilde y)$ and $y^+:=\tilde y+\theta z$, with $0\leq\theta\leq 2$. Then $\sigma(y^+)\leq\sigma(\tilde y)$.
:::
